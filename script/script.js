...
function calcularIMC(){
    ...
    function Ajudar(id){
      ...
      const img = id
      const desc = document.getElementById("desc-" + id).textContent
      const doenca = document.getElementById("doenca-" + id).textContent
      const idade = document.getElementById("idade-" + id).textContent
      const raca = document.getElementById("raca-" + id).textContent
      const valor = document.getElementById("custo-" + id).textContent.split("R$ ")[1]
      const dados = {
        nome: nome,
        img: img,
        desc: desc,
